    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-950 text-white p-6 relative">
          ...
          <div className="inline-flex items-center gap-1.5 bg-emerald-500/20 text-emerald-400 text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider mb-2">
            <Sparkles className="w-3 h-3" />
            {STORE_CONFIG.name} Loyalty Program
          </div>
          <h3 id="customer-login-title" className="text-xl font-black">Customer Member Sign In</h3>
