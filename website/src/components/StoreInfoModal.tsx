    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="bg-slate-900 text-white p-5 sm:p-6 relative">
          ...
          <div className="inline-block bg-emerald-500/20 text-emerald-400 text-[10px] font-bold px-2 py-0.5 rounded-sm uppercase tracking-wider mb-2">
            Store Information
          </div>
          <h3 className="text-xl font-black">{STORE_CONFIG.name}</h3>
          <p className="text-xs text-slate-400 mt-1">{STORE_CONFIG.tagline}</p>
        </div>
